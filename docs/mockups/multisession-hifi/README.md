...
4. **New task** — explicit managed-worktree creation, including the current unnamed-task semantics.
...
- The switcher is the dense management surface: switch, search, rename, pin, archive, attach, and inspect.
